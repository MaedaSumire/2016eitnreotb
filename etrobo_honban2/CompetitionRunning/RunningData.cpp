...
RD RunningData::referData(int now_section) {
	...
	if (gCourse == 1) { //Lコースだったら
		double mKP[7] = { 0.3, mKPStr, 1.5, mKPStr, 0.85, mKPStr, 0.81 };
		double mKI[7] = { 0.08, 0.1, 0.06, 0.1, 0.2, 0.1, 0.2 };
		double mKD[7] = { 0.01, 0.04, 0.012, 0.04, 0.02, 0.08, 0.06 };
		float mforward[7] = { mforwardStart, mforwardStr, mforwardCur,
				mforwardStr, 40, mforwardStr, 50 };
		...
		double mKP[7] = { 0.3, mKPStr, 1.4, mKPStr, 1.7, mKPStr, 1.4 };
		double mKI[7] = { 0.08, 0.1, 0.4, 0.1, 1.5, 0.1, 0.2 };
		double mKD[7] = { 0.01, 0.04, 0.02, 0.08, 0.09, 0.08, 0.02 };
		float mforward[7] = { mforwardStart, mforwardStr, mforwardCur, 60,
				mforwardCur, 50, mforwardCur };
		...
		double mKP[14] = { 0.2, 0.2, 0.2, 0, 0, 0, 1.0, 1.0, 0, 0, 0, 0, 0.2,
				0.9 };
